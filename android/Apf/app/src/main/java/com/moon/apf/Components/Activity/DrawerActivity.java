...
public class DrawerActivity extends BaseActivity{
    ...
    public BaseWebViewComponent mMenuWebviewLeft;

    public BaseRelativeComponent mMenuLayoutRight;
    public BaseWebViewComponent mMenuWebviewRight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebview = new DefaultWebViewComponent(this, "http://www.naver.com");
        ...
        mMenuWebviewLeft = new DefaultWebViewComponent(this, "http://www.google.com");

        mMenuLayoutRight = new DefaultRelativeComponent(this);
        mMenuWebviewRight = new DefaultWebViewComponent(this, "http://www.nate.com");
